...
def extract_embedding(
    ...
    embedding_model = _pretrained_speaker_embedding(
        str(model_path / "embedding"), device=device
    )
...
def read_captured_embeddings(staging_dir: Path, file_id: str) -> tuple[list[str], np.ndarray] | None:
